function overtimeStatementWindowB() {
    return Ext.create('Ext.window.Window', {
        title: 'Overtime Statement Report B',
        modal: true,
        layout: 'fit',
                ...
                handler: function() {
                    ...
                    if (form.isValid()) {
                        ...
                        if (tab_panel) {
                            ...
                            socket.emit('DownloadOverTimeStatementReportB', values).on('DownloadOverTimeStatementReportB', function(r) {
