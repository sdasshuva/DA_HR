function bonusStatementWindow() {
    return Ext.create('Ext.window.Window', {
        title: 'Bonus Statement Report',
        modal: true,
        layout: 'fit',
            ...
            buttons: [{
                ...
                handler: function() {
                    ...
                    if (form.isValid()) {
                        ...
                        values.file_name = tDate.getDate() + '_' + monthNames[values.date.getMonth()] + '_' + values.date.getUTCFullYear() + '_Bonus_Statement_Report';
                        values.sectionName = form.findField("section").rawValue.toUpperCase();
                        values.URL = site_url;
                        if (tab_panel) {
                            panel.setLoading(true);
                            socket.emit('DownloadBonusStatementReport', values).on('DownloadBonusStatementReport', function(r) {
