function salaryStatementWindowB() {
    return Ext.create('Ext.window.Window', {
        title: 'Salary Statement Report B',
        modal: true,
        layout: 'fit',
                ...
                handler: function() {
                    ...
                    if (form.isValid()) {
                        ...
                        if (tab_panel) {
                            ...
                            socket.emit('DownloadSalaryStatementReportB', values).on('DownloadSalaryStatementReportB', function(r) {
                                Ext.MessageBox.alert({
                                    title: 'Salary Statement Report Download B',
